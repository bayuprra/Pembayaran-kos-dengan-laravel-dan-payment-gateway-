                            ...
                            <div class="col-sm-12 row">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nomor Kamar" name="nomor">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="fitur[]" class="select2" multiple="multiple"
                                        ...
                                        <option>Kamar Mandi Luar</option>
                                        <option>Kasur</option>
                                        <option>AC</option>
                                        <option>Lemari</option>
                                        <option>Meja dan Kursi Belajar</option>
                                        <option>Wifi</option>
                                        <option>Dapur Bersama</option>
                                        <option>Loundri</option>
                                        <option>Parkir Motor</option>
                                        <option>Parkir Mobil</option>
                                        <option>Akses 24 Jam</option>
                                    </select>
                                </div>
                            </div>
