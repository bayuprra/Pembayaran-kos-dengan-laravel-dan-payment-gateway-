    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('updatePenyewa') }}" method="POST" id="formSave">
                        @csrf
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" pattern="[0-9]+" class="form-control"
                                            ...
                                            value="{{ $profil['kontak_darurat'] }}" required>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
    ...
    <script>
        function batal() {
            Swal.fire({
                ...
                text: "Setiap Perubahan Akan Hilang!",
                icon: 'warning',
        ...
        $("#simpan").click(function(e) {
            ...
            Swal.fire({
                title: 'Apakah Kamu Yakin?',
                text: "Setiap Perubahan Akan Disimpan!",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
